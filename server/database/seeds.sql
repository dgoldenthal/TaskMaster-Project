...
(1, 'john_admin', 'john@example.com', '$2b$10$zHIMVdzaEVxdoQenmZCYw.ljJ1j4tUBUL.o4TgA.TG/W/SMz6jNMm', 'admin'),
(2, 'jane_pm', 'jane@example.com', '$2b$10$zji/7C7c1qfZppRHs5a3g.3DCFzWDYcdOAqSKrq.ne7L923DCqm2u', 'project_manager'),
(3, 'bob_dev', 'bob@example.com', '$2b$10$zji/7C7c1qfZppRHs5a3g.3DCFzWDYcdOAqSKrq.ne7L923DCqm2u', 'user'),
(4, 'alice_dev', 'alice@example.com', '$2b$10$zji/7C7c1qfZppRHs5a3g.3DCFzWDYcdOAqSKrq.ne7L923DCqm2u', 'user');

-- Insert Projects
INSERT INTO "Projects" (id, name, description, status, start_date, due_date, "ownerId") VALUES
...
(1, 'Build API Endpoints', 'Develop secure and scalable APIs.', 'in-progress', 'high', 1, 3, 1, '2025-02-01', 40.00, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
